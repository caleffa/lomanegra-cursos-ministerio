...
def sectodur(value, arg=''):
    ...
    if secs > 0:
        ...
        # If short string is not provided or any other value
            ...
            dayUnitName = _(' día')
            hourUnitName = _(' hora')
            minUnitName = _(' minuto')
            secUnitName = _(' segundo')
        ...
        if hours > 0:
            # Add multiple days to duration string
            durationString += hourSplitter + '%02d' % hours + hourUnitName # + (hours > 1 and 's' or '')
        ...
        # if minutes > 0:
        # Add multiple days to duration string
        durationString += minSplitter + '%02d' % minutes + minUnitName # + (minutes > 1 and 's' or '')
        ...
        # if seconds > 0:
        # Add multiple days to duration string
        durationString += secSplitter + '%02d' % seconds + secUnitName # + (seconds > 1 and 's' or '')
